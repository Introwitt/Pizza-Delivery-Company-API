...
var templateHandlers = require("../routes/templates");
...
server.unifiedServer = function(req,res){
    ...
    chosenHandler = trimmedPath.indexOf("public/") > -1 ? templateHandlers.public : chosenHandler;
...
// Define routers
server.router = {
    "public"           : templateHandlers.public,
    "favicon.ico"      : templateHandlers.favicon,
    ""                 : templateHandlers.index,
    "account/create"   : templateHandlers.accountCreate,
    "account/edit"     : templateHandlers.accountEdit,
    "account/deleted"  : templateHandlers.accountDeleted,
    "session/create"   : templateHandlers.sessionCreate,
    "session/deleted"  : templateHandlers.sessionDeleted,
    "menu"             : templateHandlers.menu,
    "account/edit"     : templateHandlers.accountEdit,
